...
# [+]-------------------------------------------[+]
#  | Creator : Thonxyzz404 -X- OwlBird05                         |
...
### !/usr/bin/python3
#VERSION 1.2
#CREATED 2024 BY MR,THONXYZZ404 & OWLBIRD05
#CODED BY MR,THONXYZZ404 & OWLBIRD05
...
def banner():
    ...
    ╚█████╔╝░░╚██╔╝░╚██╔╝░███████╗██████╔╝██║██║░╚███║░░░██║░░░                  
    ░╚════╝░░░░╚═╝░░░╚═╝░░╚══════╝╚═════╝░╚═╝╚═╝░░╚══╝░░░╚═╝░░░                   
            Version 1.2 - 2024 coded by Mr,Thonxyzz404 -X- OwlBird05
...
def start():
      ...
      if chose == "1": ## MENU 1
        ...
        if V == "1": ### chose 1
                    number = input(f"{WHITE}Enter Number {NORMAL}({GREEN}Without +62xxx){WHITE} :{CRED2}➤ ")
...
####################
#CODED BY THONXYZZ404 & OWLBIRD05
...
### Start tools
start()
### CODED BY MR,THONXYZZO404 & WLBIRD05 / +6283848301116
